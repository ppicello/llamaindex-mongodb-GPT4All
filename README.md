...
A big part of this exercise was to demonstrate how you can use a locally running model like [HuggingFace](https://huggingface.co/) transformers and [GPT4All](https://gpt4all.io/index.html), instead of sending your data to OpenAI.
